...
```json
{
  ...
  "comments": {
    ...
    "sourceItem": "Optional item registry name kept for pack-defined material metadata and compatibility. Generated Tinkers Forging part textures are driven by Tinkers Construct's MaterialRenderInfoLoader when that integration is enabled.",
