...
public final class MaterialConfigLoader
{
    ...
    private static Map<String, String> getExampleComments()
    {
        ...
        comments.put("ore", "Ore dictionary name associated with this material, used for material detection and heat checks. If omitted, Tinkers Forging guesses ingot + material id, for example ingotCopper. It does not create anvil recipes by itself; add those with CraftTweaker.");
        ...
        comments.put("enabled", "If true, forces this material's generated content to appear even when the ore dictionary precondition is not currently found.");
        comments.put("noTreePunching", "If true and No Tree Punching compat is enabled, this material can register generated No Tree Punching tool part items/content. Anvil recipes still require CraftTweaker.");
