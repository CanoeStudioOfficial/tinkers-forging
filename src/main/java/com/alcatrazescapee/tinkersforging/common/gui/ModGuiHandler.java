...
package com.alcatrazescapee.tinkersforging.common.gui;
...
public final class ModGuiHandler implements IGuiHandler
{
    ...
    public static Container getServerContainer(int ID, EntityPlayer player, World world, int x, int y, int z)
    {
    ...
    {
        return getServerContainer(ID, player, world, x, y, z);
    }
    ...
    {
        return TinkersForging.getProxy().getClientGuiElement(ID, player, world, x, y, z);
    }
}
